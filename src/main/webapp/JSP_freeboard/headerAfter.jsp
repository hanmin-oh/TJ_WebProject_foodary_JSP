	...
	<!-- 네비게이션 바 -->
		<div style="height: 70px; line-height: 70px; display: flex; justify-content: space-between; background: #f0f0f0">
			<div style="padding-left : 20px;">
				<a href="/foodary_final/JSP_food/foodWrite.jsp" style="font-size: 27pt; color: black; text-decoration: none;">식단 쓰기</a>&nbsp;&nbsp;&nbsp;
				<a href="/foodary_final/JSP_diet/dietList.jsp" style="font-size: 27pt; color: black; text-decoration: none;">식단 보기</a>&nbsp;&nbsp;
