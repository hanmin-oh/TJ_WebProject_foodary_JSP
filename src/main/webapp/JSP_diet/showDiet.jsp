...
<table width="1500" align="center" border="1" cellpadding="10" cellspacing="0">
   ...
   <!-- 5 -->
   <tr>
      <form action="/foodary/JSP_food/foodUpdateOK.jsp" method="post">
      <th colspan="10">
         <input type="hidden" name="dietWriteDate" value="${dvo.dietWriteDate}" />
         <input type="hidden" name="dietWriteTime" value="${dvo.dietWriteTime}" />
         ...
         <input type="button" value="목록보기" onclick="location.href='dietListView.jsp'" style="width: 100px; height: 30px;"/>&nbsp;&nbsp;
      </th>
      </form>
   </tr>
</table>
