   ...
   <table width="300px" cellpadding="10px" cellspacing="5px;">
      <tr> 
         <th style="text-align: center;">
           <span style="background: #fafcd9; font-size: 30pt;">★ 영양소 계산기 ★</span>
         </th>   
      </tr>
      <tr>
         <th style="text-align: center;">
            <span style="background: lavender; font-size: 22pt;">현재 체중:</span>
            <input type="text" id="currentWeight" style="width: 70px; height: 25px; font-size: 25pt; border-left:0; border-right:0; border-top:0; border-bottom:5;"/> kg
         </th>
      </tr>
      <tr>
         <th style="text-align: center;">
            <span style="background: lavender; font-size: 22pt;">목표 체중:</span>
            <input type="text" id="goalWeight" style="width: 70px; height: 25px; font-size: 25pt; border-left:0; border-right:0; border-top:0; border-bottom:5;"/> kg
         </th>
      </tr>
      <tr>   
         <th style="text-align: center;">
            <span style="background: lavender; font-size: 22pt;">키:</span> 
            <input type="text" id="height" style="width: 70px; height: 25px; font-size: 25pt; border-left:0; border-right:0; border-top:0; border-bottom:5;"/> cm
         </th>      
     </tr>
      <tr>   
         <th style="text-align: center;">
           <span style="background: lavender; font-size: 22pt;">만 나이:</span> 
            <input type="text" id="age" style="width: 70px; height: 25px; border-left:0; border-right:0; border-top:0; border-bottom:5;"/> 세
         </th>      
     </tr>
      <tr>
         <th style="text-align: center;">
	...
	<tr>
      ...
      <tr>
         <th style="text-align: center;">
          	<span style="background: lavender; font-size: 22pt;">Mode:</span> &nbsp;
...
<table width="300px">
	<tr>
		<th style="text-align: center;">
           	<span style="background: #fafcd9; font-size: 30pt;">★일일 권장 영양소★</span>
        	</th>
	</tr>
	<tr>
		<th style="text-align: center;">
		<span style="background: lavender; font-size: 22pt;">칼로리</span> &nbsp;
		<input type="text" id="kcal" style="width: 70px; height: 22px; border-left:0; border-right:0; border-top:0; border-bottom:5;"/> &nbsp;kcal
		</th>
	</tr>
	<tr> 
		<th style="text-align: center;">
		<span style="background: lavender; font-size: 22pt;">탄수화물</span> &nbsp;
		<input type="text" id="carbs" style="width: 70px; height: 22px; border-left:0; border-right:0; border-top:0; border-bottom:5;"/> &nbsp;g
		</th>
	</tr>
	<tr>
		<th style="text-align: center">
		<span style="background: lavender; font-size: 22pt;">단백질</span> &nbsp;
		<input type="text" id="protein" style="width: 70px; height: 22px; border-left:0; border-right:0; border-top:0; border-bottom:5;"/> &nbsp;g
		</th>
	</tr>
	<tr>
		<th style="text-align: center;">
		<span style="background: lavender; font-size: 22pt;">지방</span> &nbsp;
		<input type="text" id="fat" style="width: 70px; height: 25px; border-left:0; border-right:0; border-top:0; border-bottom:5;"/> &nbsp;g
		</th>
	</tr>
	  <tr>
         <td colspan="2" align="center">
