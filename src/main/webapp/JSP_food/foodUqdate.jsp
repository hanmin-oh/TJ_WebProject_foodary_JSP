...
<div class="diet">
	<table width="1200" align="center" border="1" cellpadding="10" cellspacing="0">
      <!-- 1 -->
	   <tr>
	      ...
	      <td colspan="1" align="center">
	          <button  type="button" onclick="location.href='./foodListDirect.jsp'">수정</button> 
	      </td>
	   </tr>
    <!-- 3 -->
     <tr>
   ...
   <!-- 5 -->
    ...
    <table width="1200" align="center" border="1" cellpadding="3" cellspacing="0">
     <tr>
