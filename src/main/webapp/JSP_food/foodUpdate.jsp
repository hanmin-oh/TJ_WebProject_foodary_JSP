     ...
     <fmt:requestEncoding value="UTF-8"/>
      ...
      <c:forEach var="uvo" items="${list}">
        ...
        <td colspan="1" align="center">
         ...
         <td colspan="1" align="center">
            <input type="button" value="수정" onclick="location.href='updateFood.jsp?userFoodDate=${uvo.userFoodDate}&userFoodTime=${uvo.userFoodTime}' + 
               '&userFoodName=${uvo.userFoodName}&userKcal=${uvo.userKcal}&userCarbs=${uvo.userCarbs}&userProtein=${uvo.userProtein}&userFat=${uvo.userFat}'"/>
            <input type="button"  id="delete" value="삭제" onclick="location.href='deleteFood.jsp?userFoodDate=${uvo.userFoodDate}&userFoodTime=${uvo.userFoodTime}'"/>
         </td>
      </tr>
    </c:forEach>
    </tbody>
